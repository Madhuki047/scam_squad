...
| Phase 6 | Anti-cheat rate limits, security headers, deploy notes | [`docs/phase-6-polish.md`](./docs/phase-6-polish.md) |

(Phase 4 social and Phase 5 shop ship in their own PRs.)
